...
original_file_path = './wooparooData.csv'
...
# Sort the final dataframe by 'Left' column, then by 'Right' column
sorted_df = final_df.sort_values(by=['Left', 'Right']).reset_index(drop=True)

# Save the sorted dataframe to a new CSV file
output_file_path = './Sorted_Wooparoo_Data.csv'
